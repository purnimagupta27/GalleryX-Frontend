      ...
      <div className="text-left max-w-5xl">
        ...
        <div className="flex gap-8 mt-10 text-xl">
          <button 
            ...
            className="text-xs sm:text-sm font-medium tracking-widest uppercase text-white/70 hover:text-white border border-white/20 hover:border-white/60 hover:bg-white/10 py-4 px-5 sm:px-6 rounded-xl transition-all duration-500 cursor-pointer"
          >
            Upload Pictures
          </button>
        </div>
