const CTA = () => {
  return (
    <section className='max-w-7xl mx-auto px-6 sm:px-10 py-16 sm:py-24 text-center'>
      ...
      <button className='text-xs sm:text-sm font-medium tracking-widest uppercase text-white/80 hover:text-white border border-white/30 hover:border-white/60 hover:bg-white/10 py-3 sm:py-4 px-8 sm:px-10 rounded-xl transition-all duration-300 cursor-pointer shadow-md'>Get Started</button>
    </section>
  );
};
